...
@lazySingleton
class Update{{#pascalCase}}{{entity_name}}{{/pascalCase}}UseCase implements BaseUseCase<{{#pascalCase}}{{entity_name}}{{/pascalCase}}Entity, {{#pascalCase}}{{entity_name}}{{/pascalCase}}Entity> {
