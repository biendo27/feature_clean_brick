...
@lazySingleton
class GetAll{{#pascalCase}}{{entity_name}}{{/pascalCase}}sUseCase implements BaseUseCase<PageBreakRequest, BasePageBreak<{{#pascalCase}}{{entity_name}}{{/pascalCase}}Entity>> {
